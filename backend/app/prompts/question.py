...
from langchain_core.output_parsers import JsonOutputParser as SingleJsonOutputParser
...
{format_instructions}
""",
    input_variables=["grade", "unit", "difficulty", "num_questions"],
    partial_variables={"format_instructions": parser.get_format_instructions()}
)

# 既存のコードの下に追記

single_parser = SingleJsonOutputParser(pydantic_object=QuestionResponse)
